  ...
  render() {
    ...
    return (
      <Layout title={siteTitle}>
        ...
        <h2>Founder</h2>
        <p>This project was started and built by Ayman Nadeem (@aymannadeem). She had this idea for years, but started investigating the potential for it to become a Chrome plug-in in 2017. After making little progress on it for a long time, she was inspired to pick it back up when she learned that [Wayfair](https://www.thenation.com/article/wayfair-workers-walk-out/), a company she had purchased furniture from had been making a profit by selling beds to concentration camps at the center of the border migrant crisis.</p>
      </Layout>
    )
  }
}
